 ...
 */
public class GetServicesRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public GetServicesRecyclerViewAdapter(Context context, ArrayList<GetServicesDataModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycle_view_get_services, viewGroup, false);
