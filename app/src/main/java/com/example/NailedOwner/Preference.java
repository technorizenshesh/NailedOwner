package com.example.NailedOwner;
...
public class Preference {
    ...
    public static String KEY_Services_id = "services_id";
    public static String KEY_USER_Name = "userName";
    public static String KEY_USER_Email = "email";
    public static String KEY_USER_mage = "image";
    public static String KEY_CategoryId = "CategoryId";
    public static String KEY_Add_saloon_id = "CategoryId";
